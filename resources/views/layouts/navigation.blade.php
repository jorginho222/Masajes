<nav x-data="{ open: false }" class="bg-orange-300 shadow-md">
                ...
                @if(isset(Auth::user()->name))
                    ...
                    <div class="hidden flex items-center space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button class="flex items-center text-white hover:text-indigo-400">
                                    <div class="text-lg font-medium leading-5 text-white hover:text-indigo-400">
                                        Panel Admin
                                    </div>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('panel.bookings.index')">
